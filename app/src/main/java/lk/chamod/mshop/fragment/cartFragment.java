...
import lk.chamod.mshop.adpter.CartAdapter;
import lk.chamod.mshop.databinding.FragmentCartBinding;
                    ...
                    .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                        ...
                        public void onSuccess(QuerySnapshot qds) {
                            if (!qds.isEmpty()) {
                                ...
                                adapter.SetOnQuantitiyChangeLister((cartItem) -> {
//                                    Toast.makeText(getContext(), "On item change", Toast.LENGTH_SHORT).show();
                                ...
                                adapter.SetOnRemoveLister(position -> {
        ...
        binding.cartBtnProcced.setOnClickListener(v->{

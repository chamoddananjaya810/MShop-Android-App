...
import lk.chamod.mshop.adpter.ListingAdapter;
import lk.chamod.mshop.databinding.FragmentListingBinding;
...
public class ListingFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //Firebase eka paththe index ekak hadanna one eeka waradi nam
        //consloe ekee link ekak enawa eeeken idenx ekak hadaganna puluwan
...
//        Product p2 = new Product("pid2", "Scented Soy Candle Set", "Set of 3 (Lavender, Vanilla, and Sandalwood)..", 2450, "cat1", Arrays.asList("imageurl1", "imageurl2"), 20, true);
...
//        Product p4 = new Product("pid4", "Velvet Throw Pillow", "Soft touch, 18x18 inch cover with hidden zipper.", 2450, "cat1", Arrays.asList("imageurl1", "imageurl2"), 10, true);
//        Product p5 = new Product("pid5", "Golden Sunburst Mirror", "Decorative wall mirror for living room accents.", 6900, "cat1", Arrays.asList("imageurl1", "imageurl2"), 10, true);
...
//        Product p7 = new Product("pid7", "Abstract Canvas Print", "Large framed contemporary painting (24x36 inch).", 2500, "cat1", Arrays.asList("imageurl1", "imageurl2"), 10, true);
//
                    ...
                    if (!ds.isEmpty()) {
                        ...
                        adapter = new ListingAdapter(products, product -> {
                          ...
                          bundle.putString("productId",product.getProductId());
                            ...
                            // ListingFragment එකේ Click එක ඇතුළේ මෙහෙම ලියන්න
                            // ListingFragment ඇතුළේ
